...
void modelReport(char *File)
{
  FILE *fp;
	      ...
	      printf(" -W %d >> What to Scan (-W 0, Susceptible ; -W 1, Infective)\n",
		     SCAN_WHAT);
	      printf(" -F %d >> Number of Plots\n", NUMBER_of_PLOTS);
	      printf(" -N %d >> Scaning a lattice of : %d x %d data points\n", 
  ...
  fp = fopen(File, "w");
	      ...
	      fprintf(fp, " -W %d >> What to Scan (-W 0, Susceptible ; -W 1, Infective)\n",
		      SCAN_WHAT);
	      fprintf(fp, " -F %d >> Number of Plots\n", NUMBER_of_PLOTS);
	      fprintf(fp, " -N %d >> Scaning a lattice of : %d x %d data points\n", 
		      No_of_Points, No_of_Points, No_of_Points);
