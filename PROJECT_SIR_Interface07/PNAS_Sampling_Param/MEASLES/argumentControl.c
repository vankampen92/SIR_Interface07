      ...
      if(argv[argcount][0] == '-')
	{
	  ...
	  switch(argv[argcount][1])
		...
		sscanf(argv[argcount+1],"%lf",&b_1);
	      ...
	      skip++;
	      break;
	    case 'l': /* Range of Transmission rates */
	      if(argv[argcount][2]=='0')
		...
		sscanf(argv[argcount+1],"%f",&l_1);
	      ...
	      skip++;
	      break;
	    case 'D': /* Range of turnover rates */
	      if(argv[argcount][2]=='0')
		...
		sscanf(argv[argcount+1],"%f",&d_1);
	      ...
	      skip++;
	      break;
	    case 'r': /* Range of immigration rates */
	      if(argv[argcount][2]=='0')
	    ...
	    case 'h':
	      ...
	      printf(" Explored range\n");
	      printf(" -l[k]   >> Range in transmission rates\n");
	      printf("       >> k = 0,1\n");
	      printf("       >> l_0 = %g and l_1= %g\n", l_0, l_1);
	      printf(" -D[k]   >> Range in death-birth (turnover) rates\n");
	      printf("       >> k = 0,1\n");
	      printf("       >> d_0 = %g and d_1= %g\n", d_0, d_1);
	      printf(" -r[k]   >> Range in immigration levesl\n");
	      printf("       >> k = 0,1\n");
