...
void modelReport(char *File)
{
  ...
  fp = fopen(File, "w");
	      ...
	      fprintf(fp, " -h %d >> Sensibility to initial conditions\n", 
		      SENSIBILITY);
	      if(SENSIBILITY == 1){
		fprintf(fp, " Sensibility has been activated\n");
		fprintf(fp, " -s %f >> Sensibility Level\n", sensibility);
	      }
	      else fprintf(fp, " Sensibility has NOT been activated!\n");
	      fprintf(fp, " -s %f >> Sensibility to initial conditions\n", 
		      sensibility);
	      ...
	      fprintf(fp, " -l[k]   >> Loss of Immunity Range\n");
	      fprintf(fp, "       >> k = 0,1\n");
	      fprintf(fp, "       >> l_0 = %g and l_1= %g\n", l_0, l_1);
	      fprintf(fp, " -D[k]   >> Infectious Period Ragen\n");
	      fprintf(fp, "       >> k = 0,1\n");
	      fprintf(fp, "       >> d_0 = %g and d_1= %g\n", d_0, d_1);
	      fprintf(fp, " -r[k]   >> Maximum and Minimum R_0\n");
	      fprintf(fp, "       >> k = 0,1\n");
